...
2.  **[hangul](hangul/)**: Basic Hangul processing utilities (decomposition, composition, Old Hangul support)
3.  **[pronunciation](pronunciation/)**: High-performance standard pronunciation engine (pipeline architecture)
4.  **[romanization](romanization/)**: Revised Romanization converter (phonetic/literal modes)
5.  **[kulim](kulim/)**: Unified library interface
...
# 3. Romanization (Two Modes)
print(romanize("읽고"))           # -> ilkko (phonetic-based)
print(romanize_standard("읽고"))  # -> ilggo (spelling-based)
```

## Project Status & Disclaimer

While this version (`v0.1.1`) is the first official release of KULIM, it is still considered an **Experimental Release** with ongoing algorithm refinements and data structure optimizations.
